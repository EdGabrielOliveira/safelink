        ...
        {downloadLink && (
          <div className="download-link flex flex-col items-center gap-4">
            <a
              ...
              className="flex text items-center gap-2 p-3 px-6 bg-green-600 rounded-xl text-white font-semibold 
            xs:text-sm sm:text-sm md:text-base lg:text-base xl:text-base"
            >
